...
namespace clinicadental.Migrations
{
    ...
    [Migration("20250525172723_deletepretratamiento")]
    partial class deletepretratamiento
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("clinicadental.Models.Paciente", b =>
                {
                    ...
                    b.Property<string>("IdEstadoCivil")
                        .IsRequired()
                        .HasColumnType("enum('Soltero', 'Casado', 'Divorciado', 'Viudo', 'Concubino', 'Otro')");

                    b.Property<string>("IdGradoInstruccion")
                        .IsRequired()
                        .HasColumnType("enum('Inicial','Primaria', 'Secundaria', 'Universidad', 'Tecnico', 'Profesional', 'Otro')");
