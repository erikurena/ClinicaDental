...
namespace clinicadental.Migrations
{
    ...
    [Migration("20250610213138_updatefechanacpaciente")]
    partial class updatefechanacpaciente
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("clinicadental.Models.Historialclinico", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaCreacionHistorial")
                        .HasColumnType("datetime(6)");

                    b.Property<DateOnly?>("FechaHistorial")
                        .HasColumnType("date");

                    b.Property<DateTime?>("FechaModificacionHistorial")
                        .HasColumnType("datetime(6)");
            ...
            modelBuilder.Entity("clinicadental.Models.Paciente", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaCreacionPaciente")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("FechaModificacionPaciente")
                        .HasColumnType("datetime(6)");

                    b.Property<DateOnly?>("FechaNacimientoPaciente")
                        .HasMaxLength(45)
                        .HasColumnType("date");

                    b.Property<string>("IdEstadoCivil")
                        .IsRequired()
                        .HasMaxLength(45)
                        .HasColumnType("varchar(45)");

                    b.Property<string>("IdGradoInstruccion")
                        .IsRequired()
                        .HasMaxLength(45)
                        .HasColumnType("varchar(45)");

                    b.Property<string>("IdLugarNacimiento")
                        .HasMaxLength(45)
                        .HasColumnType("varchar(45)");
            ...
            modelBuilder.Entity("clinicadental.Models.PagosTratamiento", b =>
                {
                    ...
                    b.HasIndex(new[] { "IdTratamiento" }, "fk_pagostratamiento_tratamiento1_idx");
            ...
            modelBuilder.Entity("clinicadental.Models.Tratamiento", b =>
                {
                    ...
                    b.Property<DateTime?>("FechaCreacionTratamiento")
                        .HasColumnType("datetime(6)");

                    b.Property<DateTime?>("FechaModificacionTratamiento")
                        .HasColumnType("datetime(6)");
